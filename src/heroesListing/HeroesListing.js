    ...
    <section id="heroesListSection">
      <Container fluid>
        ...
        <Collapse isOpen={collapse}>
          {isCollapse && (
            <Row>
              <Col xs={{ size: 12, offset: 0 }} sm={{ size: 4, offset: 0 }} md={{ size: 3, offset: 1 }} className="mt-5">
        ...
        <Row>
          {heroes
            .filter((hero) =>
              hero.name.toLowerCase().includes(searchInputHeroList.toLowerCase())
            )
